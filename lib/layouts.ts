...
export const EXPERIENCE_DEFS: ExperienceDef[] = [
  { id: "orbit", label: "Orbit", glyph: "◎", blurb: "Rings of photos circling you like planets",
    world: { background: W_DARK, startPosition: [0, 2, 27], minDistance: 3, maxDistance: 40, fogNear: 16, fogFar: 72, autoRotate: 0.3, dimOpacity: 0.96 }, layout: orbit },
  { id: "sphere", label: "Sphere", glyph: "◍", blurb: "A globe of moments — dive inside it",
    world: { background: "#060606", startPosition: [0, 0, 32], minDistance: 1.5, maxDistance: 44, fogNear: 20, fogFar: 84, autoRotate: 0.3, dimOpacity: 0.92 }, layout: sphere },
  { id: "spiral", label: "Spiral", glyph: "๑", blurb: "An ascending helix — climb through the story",
    world: { background: W_DARK, startPosition: [0, 2, 26], minDistance: 3, maxDistance: 40, fogNear: 16, fogFar: 72, autoRotate: 0.35, dimOpacity: 0.95 }, layout: spiral },
  { id: "stream", label: "River", glyph: "≈", blurb: "Two flowing waves of photographs, one inside the other",
    world: { background: W_DARK, startPosition: [0, 3, 27], minDistance: 3, maxDistance: 40, fogNear: 16, fogFar: 70, autoRotate: 0.3, dimOpacity: 0.96 }, layout: stream },
  { id: "tunnel", label: "Tunnel", glyph: "◉", blurb: "A corridor of floating frames — dive straight through it",
    world: { background: "#050507", startPosition: [0, 0, 30], minDistance: 1, maxDistance: 36, fogNear: 20, fogFar: 110, autoRotate: 0.1, dimOpacity: 0.95 }, layout: tunnel },
  { id: "wall", label: "The Wall", glyph: "▤", blurb: "One monumental curved mosaic in front of you",
    world: { background: "#080807", startPosition: [0, 0, 30], minDistance: 4, maxDistance: 42, fogNear: 24, fogFar: 120, autoRotate: 0.08, dimOpacity: 0.97, minPolar: 0.7, maxPolar: Math.PI - 0.7 }, layout: wall },
  { id: "tower", label: "Tower", glyph: "▥", blurb: "A cylinder of stacked rings — rise through it",
    world: { background: W_DARK, startPosition: [0, 4, 30], minDistance: 2, maxDistance: 44, fogNear: 18, fogFar: 84, autoRotate: 0.4, dimOpacity: 0.95 }, layout: tower },
  { id: "dome", label: "Planetarium", glyph: "◠", blurb: "A dome of photos above you, like a painted sky",
    world: { background: "#05060a", startPosition: [0, -1, 15], minDistance: 1.5, maxDistance: 30, fogNear: 16, fogFar: 74, autoRotate: 0.25, maxPolar: Math.PI / 2 + 0.5, dimOpacity: 0.94 }, layout: dome },
  { id: "galaxy", label: "Galaxy", glyph: "✦", blurb: "Spiral arms of images — you arrive from above",
    world: { background: "#06050a", startPosition: [0, 26, 12], minDistance: 2, maxDistance: 44, fogNear: 20, fogFar: 100, autoRotate: 0.2, dimOpacity: 0.93 }, layout: galaxy },
  { id: "corridor", label: "Corridor", glyph: "‖", blurb: "Two gallery walls and a mirror aisle between them",
    world: { background: "#0b0a08", startPosition: [0, 1.5, 30], minDistance: 2, maxDistance: 34, fogNear: 20, fogFar: 120, autoRotate: 0, dimOpacity: 1, floor: { y: -5.2, radius: 40 }, minPolar: 0.9, maxPolar: Math.PI / 2 + 0.35 }, layout: corridor },
  { id: "vortex", label: "Vortex", glyph: "࿊", blurb: "A swirling funnel pulling the photos deep",
    world: { background: "#070508", startPosition: [0, 10, 26], minDistance: 3, maxDistance: 42, fogNear: 18, fogFar: 86, autoRotate: 0.3, dimOpacity: 0.94 }, layout: vortex },
  { id: "waves", label: "Waves", glyph: "〜", blurb: "A floating undulating carpet, seen from the air",
    world: { background: "#060707", startPosition: [0, 16, 30], minDistance: 3, maxDistance: 46, fogNear: 20, fogFar: 110, autoRotate: 0.2, minPolar: 0.15, dimOpacity: 0.95 }, layout: waves },
  { id: "carousel", label: "Carousel", glyph: "◌", blurb: "Majestic counter-rotating rings at eye level",
    world: { background: W_DARK, startPosition: [0, 3, 30], minDistance: 3, maxDistance: 46, fogNear: 18, fogFar: 92, autoRotate: 0.25, dimOpacity: 0.96 }, layout: carousel },
  { id: "rotunda", label: "Rotunda", glyph: "◔", blurb: "A framed museum room with a mirror floor",
    world: { background: "#0c0a07", startPosition: [0, 0, 9], minDistance: 2, maxDistance: 13.5, fogNear: 26, fogFar: 60, autoRotate: 0.3, minPolar: Math.PI / 2 - 0.55, maxPolar: Math.PI / 2 + 0.55, dimOpacity: 1, floor: { y: -5.4, radius: 22 } }, layout: rotunda },
  { id: "constellation", label: "Constellation", glyph: "✧", blurb: "A star-field — photos scattered in deep space",
    world: { background: "#04040a", startPosition: [0, 0, 28], minDistance: 1, maxDistance: 44, fogNear: 12, fogFar: 88, autoRotate: 0.22, dimOpacity: 0.9 }, layout: constellation },
  { id: "theater", label: "Theater", glyph: "◗", blurb: "A giant curved cinema of banked rows around you",
    world: { background: "#080706", startPosition: [0, 2, 20], minDistance: 3, maxDistance: 34, fogNear: 18, fogFar: 100, autoRotate: 0.1, dimOpacity: 0.97 }, layout: theater },
  { id: "stairs", label: "Staircase", glyph: "𝄜", blurb: "A grand double helix staircase of moments",
    world: { background: W_DARK, startPosition: [0, 4, 30], minDistance: 3, maxDistance: 44, fogNear: 18, fogFar: 86, autoRotate: 0.3, dimOpacity: 0.95 }, layout: stairs },
  { id: "ribbon", label: "Ribbon", glyph: "∞", blurb: "A twisting band of photos looping through space",
    world: { background: "#070608", startPosition: [0, 6, 27], minDistance: 3, maxDistance: 40, fogNear: 18, fogFar: 76, autoRotate: 0.35, dimOpacity: 0.95 }, layout: ribbon },
  { id: "cube", label: "The Cube", glyph: "▣", blurb: "You are born inside a cube lined with photographs",
    world: { background: "#060606", startPosition: [5, 3, 8], minDistance: 1, maxDistance: 11.5, fogNear: 10, fogFar: 64, autoRotate: 0.25, dimOpacity: 0.96 }, layout: cube },
  { id: "rain", label: "Rain", glyph: "☂", blurb: "Vertical strands of photos falling around you",
    world: { background: "#05060a", startPosition: [0, 2, 26], minDistance: 2, maxDistance: 40, fogNear: 16, fogFar: 78, autoRotate: 0.25, dimOpacity: 0.93 }, layout: rain },
  /* ---- new generation ---- */
  { id: "wormhole", label: "Wormhole", glyph: "◕", blurb: "A great photo torus — dive into the tube and loop it",
    world: { background: "#060509", startPosition: [0, 16, 24], minDistance: 1.5, maxDistance: 42, fogNear: 16, fogFar: 92, autoRotate: 0.28, dimOpacity: 0.94 }, layout: wormhole },
  { id: "heart", label: "The Heart", glyph: "♡", blurb: "Two nested hearts of photos — made for couples",
    world: { background: W_DARK, startPosition: [0, 1, 30], minDistance: 4, maxDistance: 44, fogNear: 22, fogFar: 110, autoRotate: 0.12, dimOpacity: 0.96 }, layout: heart },
  { id: "infinity", label: "Infinity", glyph: "∝", blurb: "A figure-eight river — love without an end",
    world: { background: "#070608", startPosition: [0, 10, 28], minDistance: 3, maxDistance: 42, fogNear: 18, fogFar: 92, autoRotate: 0.25, dimOpacity: 0.95 }, layout: infinity },
  { id: "mandala", label: "Mandala", glyph: "❋", blurb: "A rose window of photographs, petal by petal",
    world: { background: "#080607", startPosition: [0, 0, 27], minDistance: 4, maxDistance: 40, fogNear: 20, fogFar: 100, autoRotate: 0.1, dimOpacity: 0.97, minPolar: 0.8, maxPolar: Math.PI - 0.8 }, layout: mandala },
  { id: "solar", label: "Solar System", glyph: "☉", blurb: "Clusters of photos orbiting one featured sun",
    world: { background: "#050508", startPosition: [0, 10, 30], minDistance: 2, maxDistance: 46, fogNear: 18, fogFar: 96, autoRotate: 0.15, dimOpacity: 0.93 }, layout: solar },
  { id: "aurora", label: "Aurora", glyph: "☄", blurb: "Waving curtains of light made of photographs",
    world: { background: "#04070a", startPosition: [0, 3, 30], minDistance: 3, maxDistance: 44, fogNear: 18, fogFar: 96, autoRotate: 0.18, dimOpacity: 0.94 }, layout: aurora },
  { id: "sunflower", label: "Sunflower", glyph: "❁", blurb: "A golden-ratio disc — every photo a seed",
    world: { background: "#080706", startPosition: [0, 0, 30], minDistance: 4, maxDistance: 42, fogNear: 22, fogFar: 105, autoRotate: 0.12, dimOpacity: 0.97, minPolar: 0.8, maxPolar: Math.PI - 0.8 }, layout: sunflower },
  { id: "canyon", label: "Canyon", glyph: "⌒", blurb: "Two winding photo cliffs above a mirror river",
    world: { background: "#0a0806", startPosition: [0, 2, 30], minDistance: 2, maxDistance: 34, fogNear: 20, fogFar: 120, autoRotate: 0, dimOpacity: 1, floor: { y: -7, radius: 44 }, minPolar: 0.9, maxPolar: Math.PI / 2 + 0.3 }, layout: canyon },
  { id: "prism", label: "Prism", glyph: "◇", blurb: "A vast floating octahedron faced with photos",
    world: { background: "#060608", startPosition: [0, 5, 27], minDistance: 2, maxDistance: 42, fogNear: 16, fogFar: 86, autoRotate: 0.3, dimOpacity: 0.94 }, layout: prism },
  { id: "pyramid", label: "Pyramid", glyph: "△", blurb: "Four photo walls rising to a single apex",
    world: { background: "#090705", startPosition: [0, 3, 30], minDistance: 4, maxDistance: 44, fogNear: 20, fogFar: 96, autoRotate: 0.25, dimOpacity: 0.95 }, layout: pyramid },
  { id: "lattice", label: "The Grid", glyph: "⌗", blurb: "A floating 3D lattice you drift through",
    world: { background: "#060606", startPosition: [0, 6, 28], minDistance: 1.5, maxDistance: 42, fogNear: 12, fogFar: 90, autoRotate: 0.2, dimOpacity: 0.9 }, layout: lattice },
  { id: "nautilus", label: "Nautilus", glyph: "๛", blurb: "A golden spiral shell, seen from above",
    world: { background: "#080707", startPosition: [0, 24, 16], minDistance: 2, maxDistance: 44, fogNear: 18, fogFar: 100, autoRotate: 0.2, dimOpacity: 0.95 }, layout: nautilus },
  { id: "gyroscope", label: "Gyroscope", glyph: "❍", blurb: "Tilted rings interlocking like an armillary sphere",
    world: { background: "#060609", startPosition: [0, 8, 30], minDistance: 2, maxDistance: 44, fogNear: 16, fogFar: 90, autoRotate: 0.3, dimOpacity: 0.94 }, layout: gyroscope },
  { id: "fireworks", label: "Fireworks", glyph: "❈", blurb: "Frozen bursts of photographs in the night",
    world: { background: "#04040a", startPosition: [0, 0, 30], minDistance: 2, maxDistance: 44, fogNear: 14, fogFar: 92, autoRotate: 0.22, dimOpacity: 0.92 }, layout: fireworks },
  { id: "waterfall", label: "Waterfall", glyph: "𝄒", blurb: "A curtain of photos pouring into a mirror pool",
    world: { background: "#05070a", startPosition: [0, 0, 30], minDistance: 4, maxDistance: 42, fogNear: 20, fogFar: 105, autoRotate: 0.1, dimOpacity: 0.96, floor: { y: -14, radius: 40 }, minPolar: 0.7, maxPolar: Math.PI / 2 + 0.4 }, layout: waterfall },
];
